              ...
              <table className="table table-bordered table-striped" id="printTable">
                <tbody>
                  <tr>
                    ...
                    <td>{this.props.photoreport.id}</td>
                  </tr>
                  <tr>
                    <td><b>Заявитель</b></td>
                    <td>
                      {this.props.photoreport.applicant}
                      <NavLink style={{marginLeft:'5px'}} exact className="removed_in_print btn btn-raised btn-primary btn-sm" to={"/panel/photoreport/all_history/"+this.props.photoreport.user_id+"/1"}>История заявлений</NavLink>
                    </td>
                  </tr>
                  <tr>
                    <td><b>Телефон</b></td>
                    <td>{this.props.photoreport.phone}</td>
                  </tr>
                  <tr>
                    <td><b>Адрес земельного участка</b></td>
                    <td>
                      {this.props.photoreport.land_address}

                      {this.props.photoreport.land_address_coordinates &&
                  ...
                  <tr>
                    ...
                    <td>{this.props.photoreport.created_at && this.toDate(this.props.photoreport.created_at)}</td>
                  </tr>
                  ...
                  {(this.props.personalIdFile || this.props.landLocationSchemeFile) &&
                    <tr className="removed_in_print">
                      <td colSpan="2"><a className="text-info pointer" data-category="101" onClick={this.downloadAllFile.bind(this, this.props.photoreport.id)}><img style={{height:'16px'}} src="/images/download.png" alt="download"/>Скачать одним архивом</a>
