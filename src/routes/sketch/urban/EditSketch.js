...
export default class EditSketch extends React.Component {
    constructor() {
        super();
    ...
    saveApz(publish,e) {
        ...
        var link = sketchId > 0 ? ("api/sketch/region/save/" + sketchId) : "api/sketch/region/save";
        ...
        xhr.onload = function() {
            ...
            if (xhr.status === 200) {
                ...
                if (publish) {
                    ...
                    this.props.history.replace('/panel/region/sketch');
                } else {
                    alert('Заявка успешно сохранена');

                    if (!sketchId) {
                        this.props.history.push('/panel/region/sketch/edit/' + data.id);
                    }
                }
            } else {
