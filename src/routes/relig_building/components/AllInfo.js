              ...
              <table className="table table-bordered table-striped" id="printTable">
                <tbody>
                  <tr>
                    ...
                    <td>{this.props.religbuilding.id}</td>
                  </tr>
                  <tr>
                    <td><b>Заявитель</b></td>
                    <td>
                      {this.props.religbuilding.applicant}
                      <NavLink style={{marginLeft:'5px'}} exact className="removed_in_print btn btn-raised btn-primary btn-sm" to={"/panel/religbuilding/all_history/"+this.props.religbuilding.user_id+"/1"}>История заявлений</NavLink>
                    </td>
                  </tr>
                  <tr>
                    <td><b>Телефон</b></td>
                    <td>{this.props.religbuilding.phone}</td>
                  </tr>
                  <tr>
                    <td><b>Адрес земельного участка</b></td>
                    <td>
                      {this.props.religbuilding.land_address}

                      {this.props.religbuilding.land_address_coordinates &&
                  ...
                  <tr>
                    ...
                    <td>{this.props.religbuilding.created_at && this.toDate(this.props.religbuilding.created_at)}</td>
                  </tr>
                  ...
                  {(this.props.personalIdFile || this.props.landLocationSchemeFile) &&
                    <tr className="removed_in_print">
                      <td colSpan="2"><a className="text-info pointer" data-category="101" onClick={this.downloadAllFile.bind(this, this.props.religbuilding.id)}><img style={{height:'16px'}} src="/images/download.png" alt="download"/>Скачать одним архивом</a>
