            ...
            <div className="tab-pane fade" id="tab1" role="tabpanel" aria-labelledby="tab1-link">
              ...
              <div className="row">
                ...
                <div className="form-group">
                  ...
                  <input type="number" step="any" required className="form-control" name="ObjectArea" onChange={this.ObjectArea.bind(this)} disabled />
                </div>
                <div className="form-group">
            ...
            <div className="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-link">
              ...
              <div className="row">
                ...
                <div className="form-group">
                  ...
                  <input type="number" step="any" className="form-control" name="ElectricRequiredPower" placeholder="" />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <input type="number" step="any" className="form-control" name="ElectricMaxLoadDevice" placeholder="" />
                </div>
                </div>
                <div className="col-md-6">
                {/*<div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <input type="number" step="any" className="form-control" name="ElectricMaxLoad" />
                </div>
                <div className="form-group">
                  <label htmlFor="ElectricAllowedPower">Разрешенная по договору мощность трансформаторов (кВА)</label>
                  <input type="number" step="any" className="form-control" name="ElectricAllowedPower" />
                </div>
                </div>
              </div>
              <div>
            ...
            <div className="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-link">
              ...
              <div className="row">
                ...
                <div className="form-group">
                  ...
                  <input type="number" step="any" min="10" className="form-control" name="WaterFireFighting" />
                </div>
                <div className="form-group">
                  <label htmlFor="WaterSewage">Общее количество сточных вод (м<sup>3</sup>/сутки)</label>
                  <input type="number" step="any" className="form-control" name="WaterSewage" />
                </div>
                </div>
              </div>
              <div>
