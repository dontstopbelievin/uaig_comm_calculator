...
import AddHeatBlock from '../apz/citizen/AddHeatBlock';
import ReactHintFactory from 'react-hint'
const ReactHint = ReactHintFactory(React)

export default class UpdateApz extends React.Component {
    constructor(props) {
        super(props);
    ...
    saveApz(publish, elem) {
        ...
        var link =  ("api/apz/admin/save/" + apzId);
                                ...
                                <div className="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="tab0-link">
                                  ...
                                  сетей)</span></label>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input data-rh="Заявитель" data-rh-at="right" type="text" className="form-control" onChange={this.onNameChange} name="applicant" value={this.state.applicant} required />
                            ...
                            <div className="form-group">
                              ...
                              <input type="text" required className="form-control" name="ObjectName" placeholder="наименование" />
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input data-rh="Заказчик" data-rh-at="right" type="text" required onChange={this.onCustomerChange} value={this.state.customer} className="form-control customer_field" name="customer" placeholder="ФИО / Наименование компании" />
                                                </div>
                                                <div className="form-group">
