          ...
          <div>
            <div>
              <Switch>
                ...
                <Route path="/panel/citizen/apz" render={(props) => ( <Citizen {...props} breadCrumbs={this.breadCrumbs.bind(this)}/> )} />
                <Route path="/panel/citizen/sketch" render={(props) => ( <Sketch {...props} breadCrumbs={this.breadCrumbs.bind(this)}/> )} />
                <Route path="/panel/citizen/photoreports" render={(props) => ( <PhotoReportsCitizen {...props} breadCrumbs={this.breadCrumbs.bind(this)}/> )} />
                {/*  the routes is using for role: Citizen  */}
