      ...
      <div className="content container project-page">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <td width="213">
            <p><strong>Общие количество</strong></p>
            </td>
            </tr>
            <tr>
            <td width="45">
            ...
            <td width="380">
            <p>Здания обслуживания населения</p>
            </td>
            <td width="213">
            <p>3</p>
            </td>
            ...
            <td width="380">
            <p>Промышленные или производственные здания</p>
            </td>
            <td width="213">
            <p>3</p>
            </td>
            ...
            <td width="380">
            <p>Общественный пункт питание</p>
            </td>
            <td width="213">
            <p>0</p>
            </td>
            ...
            <td width="380">
            <p>Насосная станция&nbsp; реконструкция</p>
            </td>
            <td width="213">
            <p>4</p>
            </td>
            ...
            <td width="380">
            <p>Поликлиника (сейсмоусиления)</p>
            </td>
            <td width="213">
            <p>1</p>
            </td>
            ...
            <td width="380">
            <p>Троллейбусных линий все районы</p>
            </td>
            <td width="213">
            <p>1</p>
            </td>
            ...
            <td width="380">
            <p>Социально-тренинговый центр</p>
            </td>
            <td width="213">
            <p>1</p>
            </td>
