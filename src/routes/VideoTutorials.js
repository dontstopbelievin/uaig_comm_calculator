          ...
          <div className="card-body">
            <div className="list-group" id="video_list">
              ...
              <div className="video_block" id="tab1" style={{ display: 'none' }}>
                <div className="row">
                  <div className="col-sm-6">
                    <iframe width="500" height="250" src="https://www.youtube.com/embed/-BPqC07h3bc" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                  </div>
                  <div className="col-sm-6">
              ...
              <div className="video_block" id="tab2" style={{ display: 'none' }}>
                <div className="row">
                  <div className="col-sm-6">
                    <iframe width="500" height="250" src="https://www.youtube.com/embed/2sPBYBLq8gQ" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                  </div>
                  <div className="col-sm-6">
              ...
              <div className="video_block" id="tab3" style={{ display: 'none' }}>
                <div className="row">
                  <div className="col-sm-6">
                    <iframe width="500" height="250" src="https://www.youtube.com/embed/_vu65k6aLIQ" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                  </div>
                  <div className="col-sm-6">
              ...
              <div className="video_block" id="tab4" style={{ display: 'none' }}>
                <div className="row">
                  <div className="col-sm-6">
                    <iframe width="500" height="250" src="https://www.youtube.com/embed/bjhCE7sKr8s" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                  </div>
                  <div className="col-sm-6">
