...
class UrbanMenu extends Component {
  render() {
    return (
      <div>
        <NavLink to={"/panel/urban/apz/status/ractive/1"} replace className="dropdown-item" activeClassName="active">Заявления на архитектурно-планировочное задание</NavLink>
